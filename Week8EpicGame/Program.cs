string folderPath = @"C:\Users\rutko\Desktop\PROGRAMMEERIMISEALGKURSUS\week8\data";
...
Console.WriteLine($"Today {hero} ({heroHP} HP) with {heroWeapon} saves the day!"); //iga kord suvaline inimene
